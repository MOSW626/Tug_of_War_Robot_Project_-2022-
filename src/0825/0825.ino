...
// ===                         PID Setup                        ===
// ================================================================
double originalSetpoint = -70;              // degree(90) = 0
double setpoint = originalSetpoint;
double movingAngleOffset = 0.3;
double fKp=50, fKi=200, fKd=1;    //front Kpid
double bKp=32, bKi=100, bKd=0.8;    //back Kpid
...
void PID_RL()
{
    double gap = input - setpoint;      // Pitch 값은 back으로 갈 수록 값이 커진다.
                                        // 뒤로 가면 gap은 음수, 앞으로 가면 gap은 양수의 값을 지니게 됨.
    if(setpoint >= -30)
    {
